...
define view entity ZRP_XX_BOOKING 
as select from /dmo/booking_m

//Composition Child for Booking is BookingSupplement

Composition[0..*] of ZRP_XX_BOOKSUPPL as _BookingSupplement

association to parent ZRP_XX_TRAVEL as _Travel 
