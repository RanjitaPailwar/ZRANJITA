...
@EndUserText.label: 'Booking supple. as a child entity'
@Metadata.ignorePropagatedAnnotations: true
define view entity ZRP_XX_BOOKSUPPL 
as select from /dmo/booksuppl_m

association to parent ZRP_XX_BOOKING as _Booking
on $projection.BookingId = _Booking.BookingId and
 $projection.TravelId = _Booking.TravelId

association[1..1] to ZRP_XX_TRAVEL as _Travel on
